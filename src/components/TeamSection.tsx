  ...
  return (
    <section className="py-24 bg-neutral-50" id="team-section">
      <div className="container">
              ...
              <div className="grid lg:grid-cols-2 gap-0">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <button
                    ...
                    className="group relative flex items-center justify-center gap-3 w-full py-5 bg-gradient-to-r from-[#D4B78F] to-[#E6CCAF] text-white rounded-2xl hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 mb-6"
                  >
                    <Calendar className="w-6 h-6" />
                    <span className="text-xl font-medium">Boka i Solna eller Södermalm</span>
                  </button>

                  <div className="space-y-4">
                    <div className="bg-white rounded-2xl p-6 shadow-lg border border-[#D4B78F]/20 flex items-center gap-5">
                      <div className="bg-gradient-to-br from-[#D4B78F] to-[#E6CCAF] p-4 rounded-xl shadow-md">
                        <Phone className="w-6 h-6 text-white" />
                      </div>
                      <div>
                        <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#D4B78F] mb-1">Gemensam Bokning</p>
                        <a href={`tel:${salon.phone.replace(/\s/g, '')}`} className="text-2xl font-bold text-neutral-800">{salon.phone}</a>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid lg:grid-cols-5 gap-0">
              <div className="lg:col-span-2 relative h-[450px] lg:h-auto overflow-hidden">
                ...
                <motion.div 
                  ...
                  viewport={{ once: true }}
                  className="absolute top-8 left-8 z-20 bg-gradient-to-br from-[#D4B78F] to-[#B08D57] text-neutral-900 p-4 rounded-2xl shadow-2xl flex flex-col items-center"
                >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-neutral-900 via-transparent lg:bg-gradient-to-r"></div>
              </div>

              <div className="lg:col-span-3 p-8 lg:p-16 flex flex-col justify-center">
                <div className="flex flex-wrap items-center gap-3 mb-6">
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#D4B78F]/10 border border-[#D4B78F]/20">
                ...
                <p className="text-[#D4B78F] font-semibold text-lg mb-8 flex items-center gap-2">
                ...
                <a 
                  ...
                  className="group inline-flex items-center justify-center gap-3 px-8 py-5 bg-gradient-to-r from-[#D4B78F] to-[#E6CCAF] text-neutral-900 rounded-full font-bold uppercase tracking-widest text-sm shadow-xl"
                >
                  Boka med 10% rabatt
        ...
        {/* Team Section */}
        <h2 className="text-4xl font-light text-center mb-12">Vårt Team</h2>
          ...
          <>
            ...
            >
              <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 relative">
                <button onClick={() => setShowLocationPopup(false)} className="absolute top-4 right-4 p-2">
                  <X className="w-6 h-6 text-neutral-600" />
                </button>
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-light mb-2">Välj Salong</h3>
                  <p className="text-neutral-600">Var vill du boka tid?</p>
                </div>
                <div className="space-y-4">
                  <a href="https://www.bokadirekt.se/places/frisor-solna-styling-by-brazil-klinink-58888" target="_blank" className="block p-6 bg-neutral-50 rounded-2xl border-2 border-transparent hover:border-[#D4B78F] transition-all">
                    <h4 className="font-bold">Solna</h4>
                    <p className="text-sm">Solnavägen 29 H</p>
                  </a>
                  <a href="https://www.bokadirekt.se/places/sodermalm-frisor-och-brasiliansk-vaxning-stylingbybrazil-50453" target="_blank" className="block p-6 bg-neutral-50 rounded-2xl border-2 border-transparent hover:border-[#D4B78F] transition-all">
                    <h4 className="font-bold">Södermalm</h4>
                    <p className="text-sm">Götgatan 81</p>
                  </a>
                </div>
              </div>
            </motion.div>
