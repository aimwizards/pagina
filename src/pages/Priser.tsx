...
const priceList: PriceCategory[] = [
  {
    ...
    services: [
      ...
      { name: "Bottenfärg + klippning", price: "1 650 kr" },
      { name: "Bottenfärg/utväxt (+ lätt fön)", price: "1 300 kr" },
      { name: "blekning av botten/avfärgning", price: "1 700 kr" },
      { name: "färgning+klippning axellångt +långt/tjockt hår", price: "1 999 kr" },
      { name: "Slingor kort hår/highlights", price: "1 655 kr" },
      { name: "Slingor - Balayage långt hår", price: "2 500 kr" },
